...
| PASSWORD_AUTHENTICATION     | No          | `false`           | Prefer disabled in favour of Social Login.<br/>Permitted values: `true`, `false`                                                                                                |
| BCRYPT_COST                 | No          | `12`              | Cost factor for BCrypt KDF operations.<br/>Permitted values: `4`, `8`, `10`, `12`, `14`, and `16`                                                                               |
...
| SESSION_LENGTH              | No          | `P7D`             | **ISO8601 Duration**. Length of a web session before it expires                                                                                                                 |
| INVITATION_RETENTION_LENGTH | No          | `P7D`             | **ISO8601 Duration**. How long until a team invitation expires                                                                                                                  |
| PAGE_SIZE                   | No          | `100`             | **ISO8601 Duration**. Internal page size for listing operation                                                                                                                  |
| SDK_CACHE_MAX_AGE           | No          | `PT10S`           | **ISO8601 Duration**. `max-age` cache-control directive. Higher means greater cache efficiency at the risk of larger drift                                                      |
| SDK_ACTIVE_TIMEOUT          | No          | `PT10M`           | **ISO8601 Duration**. How long without contact until an SDK is considered disconnected                                                                                          |
